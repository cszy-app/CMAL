...
import com.cszyapp.cmal.data.repo.VersionsRepository
...
class AppContainer(context: Context) {
    ...
    val sourceManager: SourceManager = SourceManager(preferences)

    val versionsRepository: VersionsRepository = VersionsRepository(database, sourceManager, preferences)
